...
function bccTetraSites(elem) {
  const sites = [];
  [0, 1].forEach((z) => {
    sites.push(frac(elem, 0.5, 0.25, z), frac(elem, 0.5, 0.75, z), frac(elem, 0.25, 0.5, z), frac(elem, 0.75, 0.5, z));
  });
  [0, 1].forEach((y) => {
    sites.push(frac(elem, 0.5, y, 0.25), frac(elem, 0.5, y, 0.75), frac(elem, 0.25, y, 0.5), frac(elem, 0.75, y, 0.5));
  });
  [0, 1].forEach((x) => {
    sites.push(frac(elem, x, 0.5, 0.25), frac(elem, x, 0.5, 0.75), frac(elem, x, 0.25, 0.5), frac(elem, x, 0.75, 0.5));
  });
  return sites;
}

function bccOctaSites(elem) {
  return [
    ...faceCenters(elem),
    frac(elem, 0.5, 0, 0), frac(elem, 0.5, 1, 0), frac(elem, 0.5, 0, 1), frac(elem, 0.5, 1, 1),
    frac(elem, 0, 0.5, 0), frac(elem, 1, 0.5, 0), frac(elem, 0, 0.5, 1), frac(elem, 1, 0.5, 1),
    frac(elem, 0, 0, 0.5), frac(elem, 1, 0, 0.5), frac(elem, 0, 1, 0.5), frac(elem, 1, 1, 0.5)
  ];
}
