...
window.CRYSTAL_LIBRARY = {
  ...
  hcp: crystal("hcp", "HCP", "密排六方", "Hexagonal Close-Packed", "Mg、Zn、Ti、Co、α-Zr", "简单六方点阵 + 双原子基元", "6（常规六方晶胞）", "12", "R=a/2；理想 c/a≈1.633", "0.74", "a=b≠c；α=β=90°，γ=120°", "{0001}", "<11-20>", "掌握 ABAB 堆垛、配位数 12、致密度 0.74，以及理想轴比 c/a≈1.633。", "HCP 与 FCC 都是最密堆积；区别是 HCP 为 ABAB，FCC 为 ABCABC。", "一句话记忆：六方密排 ABAB，致密配位同 FCC。", [], { type: "hcp-honeycomb", radius: 1, c: 1.55 }, 0.84),
